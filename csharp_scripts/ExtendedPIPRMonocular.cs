...
public class ExtendedPIPRMonocular : MonoBehaviour
{
    ...
    public DiameterSmoothingManger diameterSmoothingLoop2Manager10sec;
    ...
    public List<float> F10secDiameters_os = new List<float>();
    public List<float> F10secDiameters_od = new List<float>();
    public List<float> F10secDiameters_Timestamps = new List<float>();
    ...
    public void ExtendedPIPRMonocularTest()
    {
        ClearAllList();
    ...
    void GetBaseDiameters()
    {
        for (int j = 0; j < timeStampValues_Low.Count; j++)
        {
            ...
            if (timeStampValues_Low[j] >= 0 && timeStampValues_Low[j] <= 10000)
            {
                F10secDiameters_os.Add(osDiameters_low[j]);
                F10secDiameters_od.Add(oDDiameters_low[j]);
                F10secDiameters_Timestamps.Add(timeStampValues_Low[j]);
            }
        }
    }
    ...
    void LowVariableIntensity()
    {
        ...
        diameterSmoothingManger.CalculateMovingAverage(osDiameters_low, timeStampValues_Low, 3);
        ...
        {
            // common for low , meduim, high-----------
            if (ostimeStampValues_smooth[j] >= 0 && ostimeStampValues_smooth[j] <= 10000)
            {
            ...
            ////////////////////////////////////////////////
            ///
            if (ostimeStampValues_smooth[j] > 10000 && ostimeStampValues_smooth[j] <= 20000)
            {
                leftConstrictedValue.Add(osDiameters_Smooth[j]);
                leftConstrictedTimestamp.Add(ostimeStampValues_smooth[j]);

            }
            if (ostimeStampValues_smooth[j] > 20000 && ostimeStampValues_smooth[j] <= 60000)
            {
        ...
        diameterSmoothingManger.CalculateMovingAverage(oDDiameters_low, timeStampValues_Low, 3);
        ...
        for (int j = 0; j < odtimeStampValues__smooth.Count; j++)
        {
            ...
            // common for low , meduim, high-----------
            if (odtimeStampValues__smooth[j] >= 0 && odtimeStampValues__smooth[j] <= 10000)
            {
                rightbaseValue.Add(oDDiameters_Smooth[j]);
                Right_baseValueTimestamp.Add(odtimeStampValues__smooth[j]);
            }
            /////////////////
            if (odtimeStampValues__smooth[j] > 10000 && odtimeStampValues__smooth[j] <= 20000)
            {
                rightConstrictedValue.Add(oDDiameters_Smooth[j]);
                rightConstrictedTimeStamp.Add(odtimeStampValues__smooth[j]);

            }
            if (odtimeStampValues__smooth[j] > 20000 && odtimeStampValues__smooth[j] <= 60000)
            {
    ...
    void MediumVariableIntensity()
    {
        ...
        //OS  Table Creating =============================================
        diameterSmoothingLoop2Manager10sec.CalculateMovingAverage(osDiameters_Medium, timeStampValues_Medium, 2);
        var data2 = new GraphValueCalculation(medium, "LightFlashOnSequence LeftEyeResponse", "OS", diameterSmoothingLoop2Manager10sec.amplitudeof_constrictionVal, diameterSmoothingLoop2Manager10sec.amplitudeof_DilationVal, diameterSmoothingLoop2Manager10sec.LatencyValue, diameterSmoothingLoop2Manager10sec.baseLine_Val, diameterSmoothingLoop2Manager10sec.constriction_Amount, diameterSmoothingLoop2Manager10sec.velocity_of_Constriction, diameterSmoothingLoop2Manager10sec.velocity_of_Dilation, diameterSmoothingLoop2Manager10sec.Array_Instantaneousvelocity, diameterSmoothingLoop2Manager10sec.Array_Instantaneousvelocity_Timestamps, diameterSmoothingLoop2Manager10sec.Array_01, diameterSmoothingLoop2Manager10sec.Array_01_Timestamps_first);
        resultManagerA.patientResultData.graphValueCalculation.Add(data2);

        osDiameters_Smooth = diameterSmoothingLoop2Manager10sec.Array_01;
        ostimeStampValues_smooth = diameterSmoothingLoop2Manager10sec.Array_01_Timestamps_first;
        ...
        for (int j = 0; j < ostimeStampValues_smooth.Count; j++)
        {
            ...
            if (ostimeStampValues_smooth[j] > 10000 && ostimeStampValues_smooth[j] <= 50000)
            {
                leftDilationValue.Add(osDiameters_Smooth[j]);
                leftDilationTimestamp.Add(ostimeStampValues_smooth[j]);
        ...
        diameterSmoothingLoop2Manager10sec.CalculateMovingAverage(oDDiameters_Medium, timeStampValues_Medium, 2);
        var data3 = new GraphValueCalculation(medium, "LightFlashOnSequence RightEyeResponse", "OD", diameterSmoothingLoop2Manager10sec.amplitudeof_constrictionVal, diameterSmoothingLoop2Manager10sec.amplitudeof_DilationVal, diameterSmoothingLoop2Manager10sec.LatencyValue, diameterSmoothingLoop2Manager10sec.baseLine_Val, diameterSmoothingLoop2Manager10sec.constriction_Amount, diameterSmoothingLoop2Manager10sec.velocity_of_Constriction, diameterSmoothingLoop2Manager10sec.velocity_of_Dilation, diameterSmoothingLoop2Manager10sec.Array_Instantaneousvelocity, diameterSmoothingLoop2Manager10sec.Array_Instantaneousvelocity_Timestamps, diameterSmoothingLoop2Manager10sec.Array_01, diameterSmoothingLoop2Manager10sec.Array_01_Timestamps_first);
        resultManagerA.patientResultData.graphValueCalculation.Add(data3);

        oDDiameters_Smooth = diameterSmoothingLoop2Manager10sec.Array_01;
        odtimeStampValues__smooth = diameterSmoothingLoop2Manager10sec.Array_01_Timestamps_first;
        ...
        for (int j = 0; j < odtimeStampValues__smooth.Count; j++)
        {
            ...
            if (odtimeStampValues__smooth[j] > 10000 && odtimeStampValues__smooth[j] <= 50000)
            {
                rightDilationValue.Add(oDDiameters_Smooth[j]);
                rightDilationTimestamp.Add(odtimeStampValues__smooth[j]);
    ...
    void HighVariableIntensity()
    {
        ...
        diameterSmoothingLoop2Manager10sec.CalculateMovingAverage(osDiameters_High, timeStampValues_High, 2);
        var data2 = new GraphValueCalculation(high, "LightFlashOnSequence LeftEyeResponse", "OS", diameterSmoothingLoop2Manager10sec.amplitudeof_constrictionVal, diameterSmoothingLoop2Manager10sec.amplitudeof_DilationVal, diameterSmoothingLoop2Manager10sec.LatencyValue, diameterSmoothingLoop2Manager10sec.baseLine_Val, diameterSmoothingLoop2Manager10sec.constriction_Amount, diameterSmoothingLoop2Manager10sec.velocity_of_Constriction, diameterSmoothingLoop2Manager10sec.velocity_of_Dilation, diameterSmoothingLoop2Manager10sec.Array_Instantaneousvelocity, diameterSmoothingLoop2Manager10sec.Array_Instantaneousvelocity_Timestamps, diameterSmoothingLoop2Manager10sec.Array_01, diameterSmoothingLoop2Manager10sec.Array_01_Timestamps_first);
        resultManagerA.patientResultData.graphValueCalculation.Add(data2);
        ...
        //OD  Table Creating =============================================
        // Algorithm V3 OD Values Add --------------------
        diameterSmoothingLoop2Manager10sec.CalculateMovingAverage(oDDiameters_High, timeStampValues_High, 2);
        var data3 = new GraphValueCalculation(high, "LightFlashOnSequence RightEyeResponse", "OD", diameterSmoothingLoop2Manager10sec.amplitudeof_constrictionVal, diameterSmoothingLoop2Manager10sec.amplitudeof_DilationVal, diameterSmoothingLoop2Manager10sec.LatencyValue, diameterSmoothingLoop2Manager10sec.baseLine_Val, diameterSmoothingLoop2Manager10sec.constriction_Amount, diameterSmoothingLoop2Manager10sec.velocity_of_Constriction, diameterSmoothingLoop2Manager10sec.velocity_of_Dilation, diameterSmoothingLoop2Manager10sec.Array_Instantaneousvelocity, diameterSmoothingLoop2Manager10sec.Array_Instantaneousvelocity_Timestamps, diameterSmoothingLoop2Manager10sec.Array_01, diameterSmoothingLoop2Manager10sec.Array_01_Timestamps_first);
        resultManagerA.patientResultData.graphValueCalculation.Add(data3);
